...
### 🔹 NODE_TYPE 3:
Данный режим является основным "воркером", конектится к 2 или 4 типам нод, устанавливается после них. При установки первого "воркера" нужно указать переменные RU_SITES и VPN_SITES, при установке последующих - не нужно (просто оставлять их пустыми). Далее конфигурациями можно управлять в  consul.
